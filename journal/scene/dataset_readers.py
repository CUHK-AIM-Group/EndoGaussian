...
def readColmapCameras(cam_extrinsics, cam_intrinsics, images_folder):
    ...
    for idx, key in enumerate(cam_extrinsics):
        ...
        mask_path = os.path.join(images_folder.replace("images", "masks"), f"frame-{new_num_part}.mask.png")
        ...
        # depth
        depth_path = os.path.join(images_folder.replace("images", "depth"), f"frame-{new_num_part}.depth.png")
        ...
        cam_info = Camera(colmap_id=uid, R=R, T=T, FoVy=FovY, FoVx=FovX, image=image, depth=depth, mask=mask, gt_alpha_mask=None,
                              uid=idx, data_device=torch.device("cuda"), image_name=image_name,
